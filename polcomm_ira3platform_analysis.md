---
title: "IRA Social Media Activity - Twitter, FB and Reddit"
author: "jlukito"
...
Event count are from GDELT: https://www.gdeltproject.org/data.html 
  Events were identified using the CAMEO codes: http://data.gdeltproject.org/documentation/CAMEO.Manual.1.1b3.pdf  
...
![plot of chunk plottage](figure/plottage-1.png)
...
![plot of chunk plottage](figure/plottage-2.png)
...
![plot of chunk plottage](figure/plottage-3.png)
...
![plot of chunk plottage](figure/plottage-4.png)
...
![plot of chunk plottage](figure/plottage-5.png)
...
![plot of chunk plottage](figure/plottage-6.png)
...
![plot of chunk plottage](figure/plottage-7.png)
...
![plot of chunk plottage](figure/plottage-8.png)
...
![plot of chunk fracdiff](figure/fracdiff-1.png)
All series had unit roots and were first-differenced.
...
![plot of chunk coint_trumptw](figure/coint_trumptw-1.png)
...
![plot of chunk irfs-x](figure/irfs-x-1.png)
...
![plot of chunk irfs-x](figure/irfs-x-2.png)
...
![plot of chunk plotter](figure/plotter-1.png)

```r
ggtsdisplay(residualz[,2])
```

![plot of chunk plotter](figure/plotter-2.png)

```r
ggtsdisplay(residualz[,3])
```

![plot of chunk plotter](figure/plotter-3.png)
